class Employee:
	...
	title = property(fget=__get_name, fset=None, fdel=None, doc="Return name property")

	reward = property(fget=__get_salary, fset=__set_salary, fdel=None, doc="Return name property")
